...
- real upstream lifecycle observation on the supported `apntalk/esl-react` `^0.2.2` line for live connection/session/liveness/reconnect/drain status reporting
