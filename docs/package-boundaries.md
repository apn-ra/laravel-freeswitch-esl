...
- Laravel-owned runtime handoff bundle contracts, interface-first factory seams, runner seams, esl-react binding adapters, coarse runner-feedback status surfaces, and adapter-facing scaffolding
